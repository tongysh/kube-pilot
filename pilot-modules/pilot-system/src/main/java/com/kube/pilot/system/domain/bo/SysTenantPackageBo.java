package com.kube.pilot.system.domain.bo;
...
public class SysTenantPackageBo extends BaseEntity {
     ...
     * 关联菜单id
     */
    @AutoMapping(target = "menuIds", expression = "java(com.kube.pilot.common.core.utils.StringUtils.joinComma(source.getMenuIds()))")
