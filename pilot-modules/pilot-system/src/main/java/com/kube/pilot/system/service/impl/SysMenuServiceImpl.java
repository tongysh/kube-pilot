...
import com.kube.pilot.common.core.utils.MapstructUtils;
import com.kube.pilot.common.core.utils.StreamUtils;
import com.kube.pilot.common.core.utils.StringUtils;
import com.kube.pilot.common.core.utils.TreeBuildUtils;
import com.kube.pilot.common.satoken.utils.LoginHelper;
import com.kube.pilot.system.domain.SysMenu;
import com.kube.pilot.system.domain.SysRole;
import com.kube.pilot.system.domain.SysRoleMenu;
import com.kube.pilot.system.domain.SysTenantPackage;
import com.kube.pilot.system.domain.bo.SysMenuBo;
import com.kube.pilot.system.domain.vo.MetaVo;
import com.kube.pilot.system.domain.vo.RouterVo;
import com.kube.pilot.system.domain.vo.SysMenuVo;
import com.kube.pilot.system.mapper.SysMenuMapper;
import com.kube.pilot.system.mapper.SysRoleMapper;
import com.kube.pilot.system.mapper.SysRoleMenuMapper;
import com.kube.pilot.system.mapper.SysTenantPackageMapper;
...
//        return baseMapper.selectMenuListByRoleId(roleId, role.getMenuCheckStrictly());
    ...
    public List<Long> selectMenuListByPackageId(Long packageId) {
        ...
        return baseMapper.selectObjs(new LambdaQueryWrapper<SysMenu>()
            ...
            .notIn(CollUtil.isNotEmpty(parentIds), SysMenu::getId, parentIds), x -> {
            return Convert.toLong(x);
        });
    }
    ...
    public boolean checkMenuNameUnique(SysMenuBo menu) {
        boolean exist = baseMapper.exists(new LambdaQueryWrapper<SysMenu>()
            ...
            .ne(ObjectUtil.isNotNull(menu.getMenuId()), SysMenu::getId, menu.getMenuId()));
        return !exist;
    }
