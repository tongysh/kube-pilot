...
import com.kube.pilot.common.core.domain.dto.TaskAssigneeDTO;
import com.kube.pilot.common.core.domain.model.TaskAssigneeBody;
import com.kube.pilot.common.core.service.TaskAssigneeService;
import com.kube.pilot.common.mybatis.core.page.PageQuery;
import com.kube.pilot.common.mybatis.core.page.TableDataInfo;
import com.kube.pilot.system.domain.bo.SysDeptBo;
import com.kube.pilot.system.domain.bo.SysPostBo;
import com.kube.pilot.system.domain.bo.SysRoleBo;
import com.kube.pilot.system.domain.bo.SysUserBo;
import com.kube.pilot.system.domain.vo.SysDeptVo;
...
import com.kube.pilot.system.service.ISysDeptService;
import com.kube.pilot.system.service.ISysPostService;
...
public class SysTaskAssigneeServiceImpl implements TaskAssigneeService {
    ...
    public TaskAssigneeDTO selectUsersByTaskAssigneeList(TaskAssigneeBody taskQuery) {
        ...
        // 使用封装的字段映射方法进行转换
        List<TaskAssigneeDTO.TaskHandler> handlers = TaskAssigneeDTO.convertToHandlerList(page.getRows(),
            item -> Convert.toStr(item.getId()), SysUserVo::getUserName, SysUserVo::getNickName, item -> Convert.toStr(item.getDeptId()), SysUserVo::getCreateTime);
        return new TaskAssigneeDTO(page.getTotal(), handlers);
    }
