...
import com.kube.pilot.system.domain.SysNotice;
import com.kube.pilot.system.domain.SysUser;
import com.kube.pilot.system.domain.bo.SysNoticeBo;
import com.kube.pilot.system.domain.vo.SysNoticeVo;
import com.kube.pilot.system.domain.vo.SysUserVo;
import com.kube.pilot.system.mapper.SysNoticeMapper;
import com.kube.pilot.system.mapper.SysUserMapper;
import com.kube.pilot.system.service.ISysNoticeService;
...
public class SysNoticeServiceImpl implements ISysNoticeService {
    ...
    private LambdaQueryWrapper<SysNotice> buildQueryWrapper(SysNoticeBo bo) {
        ...
        if (StringUtils.isNotBlank(bo.getCreateByName())) {
            ...
            lqw.eq(SysNotice::getCreateBy, ObjectUtils.notNullGetter(sysUser, SysUserVo::getId));
        }
