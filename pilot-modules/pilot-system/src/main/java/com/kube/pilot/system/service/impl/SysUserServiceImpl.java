...
import com.kube.pilot.system.mapper.*;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import com.kube.pilot.common.core.constant.CacheNames;
...
import com.kube.pilot.system.domain.SysUserPost;
import com.kube.pilot.system.domain.SysUserRole;
import com.kube.pilot.system.domain.bo.SysUserBo;
import com.kube.pilot.system.domain.vo.SysPostVo;
import com.kube.pilot.system.domain.vo.SysRoleVo;
import com.kube.pilot.system.domain.vo.SysUserExportVo;
import com.kube.pilot.system.domain.vo.SysUserVo;
import com.kube.pilot.system.mapper.*;
import com.kube.pilot.system.service.ISysUserService;
...
public class SysUserServiceImpl implements ISysUserService, UserService {
    ...
    private Wrapper<SysUser> buildQueryWrapper(SysUserBo user) {
        ...
        wrapper.eq(SysUser::getDelFlag, SystemConstants.NORMAL)
            .eq(ObjectUtil.isNotNull(user.getUserId()), SysUser::getId, user.getUserId())
            .in(StringUtils.isNotBlank(user.getUserIds()), SysUser::getId, StringUtils.splitTo(user.getUserIds(), Convert::toLong))
...
//                w.in(SysUser::getDeptId, ids);
        ...
        if (StringUtils.isNotBlank(user.getExcludeUserIds())) {
            wrapper.notIn(SysUser::getId, StringUtils.splitTo(user.getExcludeUserIds(), Convert::toLong));
        }
        return wrapper;
    }
...
//            .eq(ObjectUtil.isNotNull(deptId), SysUser::getDeptId, deptId)
    ...
    public boolean checkUserNameUnique(SysUserBo user) {
        boolean exist = baseMapper.exists(new LambdaQueryWrapper<SysUser>()
            ...
            .ne(ObjectUtil.isNotNull(user.getUserId()), SysUser::getId, user.getUserId()));
        return !exist;
    }
